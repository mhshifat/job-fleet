...
export async function createJob(values: IJobDtoPayload & { user_id: string, org_id: string, workflow_id?: string }) {
  ...
  const job = await db.transaction(async (trx) => {
    ...
    if (!workflow && !values?.workflow_id) {
      ...
      const selectedForAnInterview = await createAutomation({
        title: "Selected for an interview",
        org_id: values.org_id,
        flow: {
          nodes: [
              {
              ...
              },
              {
                ...
                "data": {
                    ...
                    "content": "You have been selected for an interview. Please keep an eye on your email for next step."
                },
                "measured": {
                    "width": 263,
                    "height": 288
      ...
      await createStage({
        title: "Selected for an interview",
        workflow_id: workflow.id,
        automation_id: selectedForAnInterview.id
      }, trx);
      const salaryNegotiation = await createAutomation({
          ...
          nodes: [
              ...
              },
              {
                ...
                "data": {
                    ...
                    "content": "You have been selected. Please keep an eye on your email for next step."
                },
                "measured": {
                    "width": 263,
                    "height": 288
      ...
      await createStage({
        title: "Salary Negotiation",
        workflow_id: workflow.id,
        automation_id: salaryNegotiation.id
      }, trx);
      const onboarding = await createAutomation({
          ...
          nodes: [
              ...
              },
              {
                ...
                "data": {
                    ...
                    "content": "Thank you for keeping with us."
                },
                "measured": {
                    "width": 263,
                    "height": 288
      ...
      await createStage({
        title: "Appointment Letter",
        workflow_id: workflow.id,
        automation_id: onboarding.id
      }, trx);
      const rejected = await createAutomation({
        title: "Rejected",
        org_id: values.org_id,
        flow: {
          nodes: [
              ...
              },
              {
                ...
                "data": {
                    "subject": "Rejected",
                    "content": "Thank you for applying to the job."
                },
                "measured": {
                    "width": 263,
                    "height": 288
